...
export class FirebaseWebService extends FirebaseService implements OnDestroy{
  ...
  async init(){
    const firebaseConfig = {
      apiKey: "AIzaSyCTaDMEdHp0o6mVx3ZEvgT8BGDPeJfJsBk",
      authDomain: "clinicaparadise-25cbe.firebaseapp.com",
      projectId: "clinicaparadise-25cbe",
      storageBucket: "clinicaparadise-25cbe.appspot.com",
      messagingSenderId: "677656304384",
      appId: "1:677656304384:web:5a53dcc14858959242b1e5",
      measurementId: "G-B8K6H7G74Y"
    };
